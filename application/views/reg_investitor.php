<div class="wrapper">
	<form action="<?php echo site_url("Gost/registerinvest");?>" name="forma" method="post" id="formStart">
		<h2 id="formHeading">Investitor registracija</h2>
		...
		<div class="rightForm" style="float: right; width: 50%">
			...
			<div class="formWrapper">
				...
				<label for="area">Opis investitora</label>
			</div>
			<div class="formWrapper">
				<input id="triznos" type="number" name="vrUsluga"  class="polje"/>
				<label for="triznos" class="row">Vrste usluga</label>
			</div>
			<div class="formWrapper">
				<input id="svojina" type="text" name="inviznos"  class="polje"/>
				<label for="svojina" class="row">Opseg iznosa koji zelite da investirate:</label>
			</div>
			<div class="formWrapper">
