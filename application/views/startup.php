<section class="profile">
    ...
    <div class="info">
        ...
        <div class="btns">
            <ul class="btnList">
                ...
                ?>
                <li><a class="btn" href="<?php echo site_url("KorisnikSt/arhiviraneDiskusije"); ?>">Vase arhivirane diskusije</a></li>
                <li><a class="btn" href="<?php echo site_url("KorisnikSt/izmeniProfil/" . $podaciokorisniku->id); ?>">Azuriraj profil</a></li>
            </ul>
        </div>
    ...
    if ($podaciokorisniku->slika == "") {
        echo '<div>
                <form name="upload_photo" action=' . site_url('KorisnikSt/dodajSliku') . ' method="POST" enctype="multipart/form-data">
